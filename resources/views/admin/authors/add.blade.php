                        ...
                        <form action="{{ route('authors.create') }}"  enctype="multipart/form-data" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label >Image</label>
                                        <img id="image_preview" src="https://png.pngtree.com/element_our/png/20181206/users-vector-icon-png_260862.jpg" style="width: 100px;" class="d-block my-2">
                                        <input type="file" accept="image/*" id="img" name="author_image" class="form-control-file @error('image') is-invalid @enderror">
                                    </div>
                                </div>
